Shader "RiftFX/CylinderBarrierShader"
{
	Properties
	{
		...
		_RimPower("Rim Strength", Range(0.0, 10.0)) = 1.0
		_RimSpread("Rim Spread", Range(-1.00001, 2.5)) = 0.5
		_IntersectPower("Intersect Power", Range(0, 5)) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
			#define RIFTFX_CYLINDER_BARRIER_SHADER
